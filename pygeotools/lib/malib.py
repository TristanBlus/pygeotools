...
def angle(p1, p2, shape=None):
    ...
    angle = math.atan2(delta_y, delta_x) % (math.pi * 2) - math.pi
    ...
    if delta_x == 0:
        ...
        w_y = math.ceil(p1y - p1x * (delta_y/delta_x))
        w_x = math.ceil(p1x - p1y * (delta_x/delta_y))
        w_d = math.sqrt(w_y**2 + w_x**2)
